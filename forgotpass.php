...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Reset Password | Biolife - Organic Food</title>
                ...
                <div class="container md-possition-relative">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-md-12 col-xs-12" style="display: flex; align-items: center;">
                            ...
                            <div style="font-family: 'Cairo', sans-serif; font-size: 30px; font-weight: bold">Reset Password</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="page-contain login-page" style="background-color: #f0f2f5">
            ...
            <div id="main-content" class="main-content">
                <div class="container">
                    ...
                    <div class="row" style="margin-top: 155px;background-color: #f0f2f5; margin-bottom: 155px; align-items: center; display: flex;">
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-8 col-xs-8" style="background-color: #ffffff; border-radius: 7px;box-shadow: 0 2px 4px rgb(0 0 0 / 10%), 0 8px 16px rgb(0 0 0 / 10%)">
                            <div class="signin-container">
                                ...
                                <form action="" name="frm-login" method="post" class="register-form">
                                    <p class="form-row">
                                        <label for="fmail">Email Address <span class="requite">*</span></label>
                                        <input type="email" id="fmail" name="fmail" value="" class="txt-input" required>
                                    </p>
                                    <p class="form-row wrap-btn">
<!--                                        <button class="btn btn-submit btn-bold" type="button" name="backForgot" onclick="window.location.href='login.php?from=<?php echo url2; ?>'">Back</button>-->
                                        <button class="btn btn-submit btn-bold" type="button" onclick="forgotCheck()" name="submitForgot">Continue</button><br><br>
                                        <a href="login.php?<?php echo $query; ?>" class="link-to-help" style="vertical-align: unset; margin-left: 5px">Back to sign in</a>
                                    </p>
                                </form>
                            </div>
                        </div>
