...
<!--                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-md">
                                        <a href="productedit.php?action=create" class="btn btn-primary">Add <i
                            ...
                            <table class="table table-bordered table-striped mb-none" id="datatable-editable" style="text-align: center;">
                                ...
                                include '../model/categories_data.php';
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            $i = $i + 1;
                                            $imgURL = "../" . $row["cate_imageURL"];
                                            ?>
                                            <tr class="gradeA">
                                                <td class="item"><?php echo $i; ?></td>
                                                <td class="item"><?php echo $row["cate_name"]; ?></td>
                                                <td class="item">
                                                    <img src="<?php echo $imgURL; ?>" width="50px" height="50px" alt="alt"/>
                                                </td> 
                                                <td class="actions">
                                                    <a href="productview.php?category=<?php echo $row["cate_id"]; ?>" class="on-default"><i class="fa fa-paper-plane-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
