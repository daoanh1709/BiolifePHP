    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                var url1 = '../' + $('#imageInfo').attr('src');
                $("#productImage").fileinput({
                    initialPreview: [url1],
                    initialPreviewAsData: true,
                    defaultPreviewContent: '<img src="' + url1 + '" alt="Your Avatar" style="height:160px">',
                    showUpload: false
                });
            });
        </script>
        ...
        <section class="body">
            ...
            <div class="inner-wrapper">
                ...
                <section role="main" class="content-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="form-horizontal form-bordered" action="" method="post" id="formProduct" enctype="multipart/form-data">
                                <section class="panel">
                                    ...
                                    <footer class="panel-footer" id="edit-footer">
                                        <div class="row">
                                            <div class="col-sm-10 col-sm-offset-2">
                                                <input type="submit" onclick="checkProduct1();" value="Submit" class="btn btn-primary" id="submitProduct" name="submitProduct">
